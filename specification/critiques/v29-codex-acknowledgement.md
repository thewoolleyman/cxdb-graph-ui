...
A proposed holdout scenario ("DOT prompt containing HTML markup renders as literal text") was also written to `holdout-scenarios/proposed-holdout-scenarios-to-review.md` to exercise this requirement.

Changes:
- `specification/cxdb-graph-ui-spec.md`: Added "HTML escaping" paragraph in Section 7.1 after the DOT attributes table.
- `holdout-scenarios/proposed-holdout-scenarios-to-review.md`: Added HTML injection holdout scenario proposal.
