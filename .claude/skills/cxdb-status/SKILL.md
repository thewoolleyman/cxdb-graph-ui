...
> CXDB is not reachable at `http://$KILROY_CXDB_HOST:9120`. Start it with:
> ```
...
- **If everything looks healthy:** "Pipeline is progressing normally. Open `http://$KILROY_CXDB_HOST:9120` for the full CXDB console."
