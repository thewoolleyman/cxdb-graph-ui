...
Additionally, a proposed holdout scenario for `/nodes` prefetch non-400 failures was written to `holdout-scenarios/cxdb-graph-ui-holdout-scenarios.md` to complement the existing DOT parse error scenario.

Changes:
- `specification/cxdb-graph-ui-spec.md`: Added error handling contract to Step 4 of Section 4.5
- `holdout-scenarios/cxdb-graph-ui-holdout-scenarios.md`: Added proposed scenario for `/nodes` prefetch non-400 failure
